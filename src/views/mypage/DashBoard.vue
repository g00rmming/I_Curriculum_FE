            ...
            <div class="col-md-6 col-lg-3">
              <div class="card border">
                ...
                <div class="card-body">
                  ...
                  <div class="h1 my-1 me-2">3.5 /<span>(4.5)</span>
                  </div>
                  <div class="me-auto">
                    <span v-if="costData.projectPercent === 'null' || costData.projectPercent === Infinity"
                      class="text-yellow d-inline-flex align-items-center lh-1">
                      전월 정보 없음
                    </span>
                    <span v-else-if="costData.projectPercent > 0" class="text-green d-inline-flex align-items-center lh-1">
                      전월대비% 증가
                    ...
                    <span v-else-if="costData.projectPercent === 0"
                      class="text-yellow d-inline-flex align-items-center lh-1">
                      전월과 동일
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon ms-1" width="24" height="24" viewBox="0 0 24 24"
                        stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <span v-else class="text-red d-inline-flex align-items-center lh-1">
                      전학기 대비 500000% 감소
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trending-down" width="24"
            ...
            <div class="col-md-6 col-lg-3">
              <div class="card border">
                ...
                <div class="card-body">
                  ...
                  <div class="h1 my-1 me-2">4.5/(4.5)</div>
                  <div class="me-auto">
                    <span v-if="costData.effectiveTotalPercent === 'null' || costData.effectiveTotalPercent === Infinity"
                      class="text-yellow d-inline-flex align-items-center lh-1">
                      전월 정보 없음
                    </span>
                    <span v-else-if="costData.effectiveTotalPercent > 0"
